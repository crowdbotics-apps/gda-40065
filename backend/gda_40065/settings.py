"""
Django settings for gda_40065 project.
...
WSGI_APPLICATION = 'gda_40065.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gda_40065 API",
    "DESCRIPTION": "API documentation for gda_40065 App",
    "VERSION": "v1",
}
